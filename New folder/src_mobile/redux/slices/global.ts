...
export const globalSlice = createSlice({
  ...
  reducers: {
    ...
    updateSideBarSection: (state, action) => {
      state.sidebar.section = action.payload;
    },
  },
});

// Action creators are generated for each case reducer function
export const { updateStock, updateStockList, updateStrategySelection, updateStrategyCurrentSelection, updateSideBarSection } =
  globalSlice.actions;
