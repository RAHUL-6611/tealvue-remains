  ...
  return (
    <>
      {loading ? (
        ...
        <Section>
          <Top>
            <h1>{details?.stock?.fullname}</h1>
            <ul>
              <li>
                SPOT : {details?.stock?.spot?.price} &nbsp; ({floatFormatter(details?.stock?.spot?.price_change)}%)
              </li>
              <li>
                FUTURES : {details?.stock?.future?.price} &nbsp; ({floatFormatter(details?.stock?.future?.price_change)}%)
              </li>
              <li>PCR : {floatFormatter(details?.stock['pcr_oi'])} </li>
              <li>MAX PAIN : {details?.stock['maxpain']}</li>
            </ul>
          </Top>
